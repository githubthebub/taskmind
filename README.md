...
- **Mudra mode** — the coach gets hands; large labeled finger-map diagrams (T·I·M·R·L) show exactly which fingertips touch (Wisdom pinch/Gyan, Meditation bowl/Dhyāna, Prayer press/Añjali, Vitality pinch/Prāṇa). Associations are worded as tradition, not promised effects.
