import type { AudioProfile, BreathPhase } from './types.js';
...
export class OscillatorEngine {
  ...
  private fundL: OscillatorNode | null = null;
  private fundR: OscillatorNode | null = null;

  private spatial: OscillatorNode | null = null;
  private panLfo: OscillatorNode | null = null;
  private fmLfo: OscillatorNode | null = null;
   ...
   * half-started graph.
   */
  start(initialPhase: BreathPhase): void {
  ...
  private buildGraph(ctx: AudioContext, p: AudioProfile, initialPhase: BreathPhase): void {
    ...
    for (const osc of [fundL, fundR, spatial, panLfo, fmLfo]) osc.start(now);
  }
