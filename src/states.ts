import type { StateConfig, StateKey } from './types.js';
 ...
 */
export const STATE_MATRIX: Record<StateKey, StateConfig> = {
  piti: {
    key: 'piti',
    title: 'Somatic Rapture',
    subtitle: 'Pīti Matrix',
    description:
      'Energetic full-body absorption. Cascading micro-pulse haptics ride every breath ' +
  ...
  sukha: {
    ...
    subtitle: 'Sukha Base',
    description:
      'Settled, unshakeable contentment. Slow spatial drift, near-silent haptics, and ' +
  ...
  flow: {
    ...
    subtitle: 'Flow State',
    description:
      'Task-ready executive focus. Crisp metronomic haptics, tighter modulation, and ' +
...
export const STATE_ORDER: readonly StateKey[] = ['piti', 'sukha', 'flow'];
